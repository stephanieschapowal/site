...
<div class="carousel">
  ...
  <div class="carousel-track">
    ...
    <div class="carousel-slide">
      <img src="/img/moma-dvg/dvg-carousel-Onthisfloor.png" alt="Two mobile screens of the MoMA visitor guide map showing floor 5 selected. Below the interactive floor plan, an "On this floor" section lists collection galleries with artwork thumbnails tagged "Now on view," artist names, and gallery numbers, followed by amenities like the Terrace 5 Bar.">
    ...
    <div class="carousel-slide">
      <img src="/img/moma-dvg/dvg-carousel-overlay.png" alt="Two mobile screens showing a gallery detail overlay on the MoMA map. A panel slides up over the map for Gallery 202, showing the title "Mike Kelley's Deodorized Central Mass with Satellites," a brief description, artworks on view with thumbnails, and a list of artists in the gallery.">
    ...
    <div class="carousel-slide">
      <img src="/img/moma-dvg/dvg-carousel-links.png" alt="Three mobile screens showing how on-view artworks are surfaced across moma.org: a Works search results page with an "On view" label and gallery number on a Frida Kahlo painting, an artwork detail page with a highlighted "On view" location link reading "MoMA, Floor 5, 517," and the visitor guide map with Gallery 517 "Surrealist Objects" open in an overlay.">
