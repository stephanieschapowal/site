  ...
  <div class="carousel-track">
    ...
    <div class="carousel-slide">
      <img src="/img/moma-ticketing/ticketing-carousel-box.png" alt="A persistent order summary box and progress bar is displayed alongside the checkout form.">
            <p class="caption">On mobile, an always-present order summary, progress bar, and "Next" CTA clarified a user's status and next steps as they complete checkout.</p>
    </div>
    <div class="carousel-slide">
